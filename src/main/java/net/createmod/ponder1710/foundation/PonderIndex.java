...
import net.createmod.ponder1710.foundation.registration.DefaultPonderSceneRegistrationHelper;
import net.createmod.ponder1710.foundation.registration.DefaultPonderTagRegistrationHelper;
import net.createmod.ponder1710.foundation.registration.DefaultSharedTextRegistrationHelper;
import net.createmod.ponder1710.foundation.registration.PonderLocalization;
import net.createmod.ponder1710.foundation.registration.PonderSceneRegistry;
import net.createmod.ponder1710.foundation.registration.PonderTagRegistry;
...
public class PonderIndex {
    ...
    public static boolean editingModeActive() {
        // .get() not available - direct field access in 1.7.10
        return PonderConfig.client().editingMode;
    }
}
