// PORT LATER - 1.7.10
package net.createmod.metanip.config.ui.entries;
...
import net.createmod.metanip.config.ui.ConfigAnnotations;
import net.createmod.metanip.config.ui.ConfigHelper;
import net.createmod.metanip.config.ui.ConfigScreen;
import net.createmod.metanip.config.ui.ConfigScreenList;
import net.createmod.metanip.config.ui.SubMenuConfigScreen;
