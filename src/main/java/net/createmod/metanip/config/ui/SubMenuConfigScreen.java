package net.createmod.metanip.config.ui;
...
import net.createmod.metanip.config.ui.ConfigScreenList.LabeledEntry;
import net.createmod.metanip.config.ui.entries.BooleanEntry;
import net.createmod.metanip.config.ui.entries.EnumEntry;
import net.createmod.metanip.config.ui.entries.NumberEntry;
import net.createmod.metanip.config.ui.entries.StringEntry;
import net.createmod.metanip.config.ui.entries.SubMenuEntry;
import net.createmod.metanip.config.ui.entries.ValueEntry;
import net.createmod.metanip.data.Couple;
import net.createmod.metanip.data.Pair;
import net.createmod.metanip.gui.ConfirmationScreen;
import net.createmod.metanip.gui.ConfirmationScreen.Response;
